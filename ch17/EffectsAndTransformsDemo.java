// Demostrate rotation, scaling, reflection and blurring.
...
public class EffectsAndTransformsDemo extends Application {
	...
	public void start(Stage myStage) {
		...
		// Use a FlowPane for the root node. In this case, vertical
		// and horizontal gaps of 20 are used.
		...
		// Set the reflection effect on the reflectino label.
		reflection.setTopOpacity(0.7);
		reflection.setBottomOpacity(0.3);
		reflect.setEffect(reflection);

		// Handle the action events for the Rotate burron.
		btnRotate.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent ae) {
				// Each time a button is pressed, it is rotated 30 degrees around its center.
				angle += 15.0;
