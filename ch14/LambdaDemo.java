// Demostrate two simple lambda expressions.
...
class LambdaDemo {
	public static void main(String args[]) 
	{
		 ...
		 * in which the lambda expression implements
		 ...
		 * to a MyParamValue reference. This lambda expression returns
		...
		// defined by the functional interface. Therefore, these
		// wont work:
		// myVal = () -> "three"; // Error! String not comp with double
		// myPval = () -> Math.random(); // Error! parameter requiered
