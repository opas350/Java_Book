// Demostrate a method refernce for a static method.
...
class MethodRefDemo {
	...
	// This method has a functinoal interface as the type of its
	// first parameter. Thus, it can be passed a reference to any 
	// instance of that interface, including one created
	...
	public static void main(String args[]) {
		...
		// Here, a method reference to isPrime is passed
		// to numTest().
