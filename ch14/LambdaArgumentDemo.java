...
class LambdaArgumentDemo {
	...
	// This method has a functional interface as a type of
	// its first parameter. Thus, it can be passed a reference to any
	// instance of that interface, including an instance created
	// by a lambda expression. The second parameter specifies the string
	// to operate on.
	...
	public static void main(String args[])
	{
		...
		System.out.println("The string reverse: " + outStr);
		...
		// string. It is also embedded directly in the call to
		// changeStr().
