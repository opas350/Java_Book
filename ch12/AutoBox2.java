...
class AutoBox2 {
	...
	static Integer m3() {
		return 99;  // autoboxint 99 into an Integer.
	}
	...
	public static void main(String args[]) {
		...
		// Here, iOb receives the int value return by m2().
		...
		//  Next, Match.sqrt() is called with iOb as an argument.
		//  In this case, iOb is auto-unboxed and its value prmoted to
